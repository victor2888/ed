...
{
	private global::Gtk.VBox vBox1Main;
	...
	protected virtual void Build ()
	{
		...
		this.vBox1Main = new global::Gtk.VBox ();
		this.vBox1Main.Name = "vBox1Main";
		this.vBox1Main.Spacing = 6;
		// Container child vBox1Main.Gtk.Box+BoxChild
		...
		w2.Position = 1;
		this.vBox1Main.Add (this.hbox1);
		global::Gtk.Box.BoxChild w3 = ((global::Gtk.Box.BoxChild)(this.vBox1Main [this.hbox1]));
		w3.Position = 0;
		w3.Expand = false;
		w3.Fill = false;
		// Container child vBox1Main.Gtk.Box+BoxChild
		...
		this.vBox1Main.Add (this.buttonGoForward);
		global::Gtk.Box.BoxChild w4 = ((global::Gtk.Box.BoxChild)(this.vBox1Main [this.buttonGoForward]));
		w4.Position = 1;
		w4.Expand = false;
		w4.Fill = false;
		// Container child vBox1Main.Gtk.Box+BoxChild
		...
		this.vBox1Main.Add (this.labelSaludo);
		global::Gtk.Box.BoxChild w5 = ((global::Gtk.Box.BoxChild)(this.vBox1Main [this.labelSaludo]));
		w5.Position = 2;
		w5.Expand = false;
		w5.Fill = false;
		this.Add (this.vBox1Main);
		if ((this.Child != null)) {
			this.Child.ShowAll ();
		}
